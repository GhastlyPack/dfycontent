 ...
 * Thesis: Premium positioning. Serif display, cream paper, long subheads,
 * numbered articles, pull quotes. Reads like a feature, not a sales page.
 */
      ...
      <div style={{ background: PAPER, color: INK, minHeight: '100vh' }}>
        ...
        <header style={{ borderBottom: `1px solid ${RULE}`, padding: '20px 32px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div style={{ display: 'flex', alignItems: 'baseline', gap: 12 }}>
            <Link href="/" style={{ fontFamily: SERIF, fontSize: 22, letterSpacing: '-0.02em' }}>
              DFY Content
            </Link>
          ...
          <Link href="/apply" style={{ fontFamily: BODY, fontSize: 13, fontWeight: 600, padding: '10px 20px', border: `1px solid ${INK}`, borderRadius: 999, color: INK }}>
            Apply
          </Link>
        </header>
        ...
        <section style={{ borderTop: `1px solid ${RULE}`, padding: '80px 32px' }}>
          <div style={{ maxWidth: 1120, margin: '0 auto', display: 'flex', flexDirection: 'column', gap: 64 }}>
            {[
              ...
              <article key={n} style={{ display: 'grid', gridTemplateColumns: '80px 1fr', gap: 32, alignItems: 'baseline' }}>
                <span style={{ fontFamily: SERIF, fontSize: 64, fontWeight: 400, color: ACCENT, fontStyle: 'italic' }}>{n}</span>
                <div>
                  <h2 style={{ fontFamily: SERIF, fontSize: 36, fontWeight: 400, margin: 0, letterSpacing: '-0.015em', lineHeight: 1.1 }}>
                    {h}
                  </h2>
                  <p style={{ fontFamily: BODY, fontSize: 17, lineHeight: 1.65, color: MUTED, marginTop: 14, maxWidth: 640 }}>
                    {b}
                  </p>
                </div>
              </article>
